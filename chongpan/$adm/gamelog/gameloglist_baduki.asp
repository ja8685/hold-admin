...
sql="select count(*) from common_game_log a inner join users b on a.user_id=b.user_id  where 1=1 and b.user_distributor2_link=" & adminNo & searchSQL
                ...
                <div class="x_panel">
                 ...
                 <%
                    ...
                    'sql=sql&" order by game_start_time desc) a inner join v_game_log_new b on a.game_id=b.game_id where 1=1 "&searchSQL&" order by a.game_start_time desc"
	                    ...
	                    SQL = SQL & "					WHERE 1=1 and b.user_distributor2_link=" & adminNo & searchSQL
	                    SQL = SQL & "			) AA "
