...
sql="select * from (select a.user_id,user_nick,user_money as user_money,user_save as user_save,c.user_ip as connect_status,user_currentdate,a.user_regdate,user_phone as f_hp,'' as f_email,shop_id,chongpan_id,bonsa_id from users a with(nolock) "
