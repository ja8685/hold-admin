                  ...
                  <div class="x_content">
                    ...
                    <form data-parsley-validate class="form-horizontal form-label-left" name="frm1" method="post" action="update_user_pwd_ok.asp">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="user_ECpwd" class="date-picker form-control col-md-7 col-xs-12" name="user_ECpwd" type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="user_ECpwd_chk" class="date-picker form-control col-md-7 col-xs-12" name="user_ECpwd_chk" type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        ...
                        <div class="form-inline col-md-6 col-sm-6 col-xs-12">
                          <select name="hp_1" class="form-control col-md-6 col-sm-6 col-xs-3">
            	            <option value="010" <%if hp1="010" then response.write "selected" end if%>>010</option>
               	            <option value="011" <%if hp1="011" then response.write "selected" end if%>>011</option>
                            <option value="016" <%if hp1="016" then response.write "selected" end if%>>016</option>
                            <option value="017" <%if hp1="017" then response.write "selected" end if%>>017</option>
                            <option value="018" <%if hp1="018" then response.write "selected" end if%>>018</option>
                            <option value="019" <%if hp1="019" then response.write "selected" end if%>>019</option>
                            <option value="070" <%if hp1="070" then response.write "selected" end if%>>070</option>
                            <option value="0505" <%if hp1="0505" then response.write "selected" end if%>>0505</option>
                          </select>
                            <input name="hp_2" type="text" class="form-control col-md-6 col-sm-6 col-xs-3" id="hp_2" onChange="isNumber(this)" onKeyUp="isNumber(this)" value="<%=hp2%>"> 
                          <input name="hp_3" type="text" id="hp_3" class="form-control col-md-6 col-sm-6 col-xs-3" onChange="isNumber(this)" onKeyUp="isNumber(this)"  value="<%=hp3%>">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
