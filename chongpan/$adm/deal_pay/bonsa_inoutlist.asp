...
PageSize = page_size
    ...
    sql=sql&" group by jisa_id,chongpan_id,shop_id,take_id,user_account_name,status having chongpan_id='"&adminID&"' "
    ...
    sql=sql&" group by a.jisa_id,a.chongpan_id,a.shop_id,a.take_id,user_account_name,a.status having a.chongpan_id='"&adminID&"' "
    ...
    sql=sql&" group by b.jisa_id,b.chongpan_id,b.shop_id,a.user_id ,user_account_name,a.status having b.chongpan_id='"&adminID&"' and a.status=1 and b.chongpan_id<>''"
    ...
    sql = sql&" having a.chongpan_id='"&adminID&"' and a.chongpan_id<>''"
    ...
    sql = sql&" GiftToLog a inner join users b on a.to_user=b.user_id inner join v_member_list01 c on b.user_id=c.user_id where user_distributor2_link="&request.Cookies(admincheck)("adminNO")&" and a.date between"
    ...
    sql = sql&" GiftToLog a inner join users b on a.from_user=b.user_id inner join v_member_list01 c on b.user_id=c.user_id where user_distributor2_link="&request.Cookies(admincheck)("adminNO")&" and a.date between"
    sql = sql&" '"&sdate&"' and '"&ldate&"'"
    if keyword <> "" then 
        if keyfield="take_id" then
