                  ...
                  <table border="0" cellpadding="0" cellspacing="0" background="../images/left_top.gif" height="34" width="170">
                    <Tr> 
                      <td valign="bottom"> 
                        <table border="0" cellpadding="0" cellspacing="0">
                          <Tr> 
                            <td style="padding-left:35;padding-bottom:5"><b><font color="#ffffff">본사 관리</font></b></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                      ...
                      <td style="padding-left:10" height="25"> 
                        <table border="0" cellpadding="0" cellspacing="0">
                          <Tr> 
                            ...
                            <td align="center" style="padding-left:5"><a href="/$adm/Head/HeadList.asp"> 
                              본사 리스트</a></td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr> 
                      <td style="padding-left:10" height="25"> 
                        <table border="0" cellpadding="0" cellspacing="0">
                          <Tr> 
                            <td align="center"><img src="../images/left_icon.gif" border="0" hspace="3"></td>
                            <td align="center" style="padding-left:5"><a href="/$adm/Head/HeadMoneyChargeList.asp"> 
                              본사 머니 지급내역</a></td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr> 
                      <td style="padding-left:10" height="25"> 
                        <table border="0" cellpadding="0" cellspacing="0">
                          <Tr> 
                            <td align="center"><img src="../images/left_icon.gif" border="0" hspace="3"></td>
                            <td align="center" style="padding-left:5"><a href="/$adm/Head/regHeadMoneyCharge.asp"> 
                              본사 머니 추가지급</a></td>
                          </tr>
                        </table>
                      </td>
