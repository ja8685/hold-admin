...
sql="select deal_money from distributor2 where user_id IN ('" & request.Cookies(admincheck)("adminID") & "')"
...
sql=sql&" where b.chongpan_id='"&adminID&"' and grade in  (2,3,4)"
...
'sql=sql&" where b.chongpan_id='"&adminID&"'" 
                    ...
                    <%
                     ...
                     %>
                      ...
                      <%else 
                          ...
                          sql=sql&" select a.* from GiftToLog a with(nolock) inner join v_all_member_list b with(nolock) on a.from_user=b.user_id where b.chongpan_id='"&adminID&"' and grade in  (2,3,4)"
                          sql=sql&" and date between '"&sdate&"' and '"&ldate&"'"&searchSQL
                         ' sql=sql&" union "
                         ' sql=sql&"   select a.* from GiftToLog a with(nolock) inner join v_all_member_list b with(nolock) on a.to_user=b.user_id where b.chongpan_id='"&adminID&"' "
                         ' sql=sql&" and date between '"&sdate&"' and '"&ldate&"'"&searchSQL
