...
bonsa_no    = Request("bonsa_no")
sql="select user_id from distributor1 where number="&request.Cookies(admincheck)("adminNo")
chongpan_id  = Replace(GetString_List(sql),RowDel,"")            
end if
  sql="select distributor15_rate from dealer_rate_manager"
 ...
 %>
  <%else 
	    ...
	    For i = 0 to UBound(Rows)-1
            ...
            sql="select distribute1_rate from distributor1 where number="&request.Cookies(admincheck)("adminNo")            
...
<!--//
 ...
 function chk_id() {
        ...
        xmlHttp.open("get", "view_jisa_game_id.asp?request_id=" + escape(id) +"&grade=4", false);
...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                 
                    <form class="form-horizontal form-label-left" name="frm1" method="post" action="insert_jisa_ok.asp?bonsa_no=<%=bonsa_no%>&chongpan_no=<%=chongpan_no%>&bonsa_rate_tot=<%=bonsa_rate_tot%>&bonsa_rate=<%=bonsa_rate%>">
                        <input type="hidden" name="user_id" value="<%=user_id%>" />
                        <input type="hidden" name="exist_id" value="N" />                        
                        <input type="hidden" name="exist_name" value="N" />                        
                      ...
                      <div class="ln_solid"></div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">본사명
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class="control-label" for="user_id">
