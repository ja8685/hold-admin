                  ...
                  <table border="0" cellpadding="0" cellspacing="0" background="../images/left_top.gif" height="34" width="170">
                    <Tr> 
                      <td valign="bottom"> 
                        <table border="0" cellpadding="0" cellspacing="0">
                          <Tr> 
                            <td style="padding-left:35;padding-bottom:5"><b><font color="#ffffff">게시판 관리</font></b></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                      ...
                      <td style="padding-left:10" height="25"> 
                        <table border="0" cellpadding="0" cellspacing="0">
                          <Tr> 
                            ...
                            <td align="center" style="padding-left:5"><a href="/board/board_list.asp?b_index=공지사항"> 
                              공지사항</a></td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr> 
                      <td style="padding-left:10" height="25"> 
                        <table border="0" cellpadding="0" cellspacing="0">
                          <Tr> 
                            <td align="center"><img src="../images/left_icon.gif" border="0" hspace="3"></td>
                            <td align="center" style="padding-left:5"><a href="/board/alertList.asp"> 
                              알림판</a></td>
                          </tr>
                        </table>
                      </td>
