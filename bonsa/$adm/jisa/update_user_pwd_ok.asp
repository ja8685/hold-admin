...
user_ECpwd=checkvalue(1,trim(request.Form("chongpan_ce_pwd")))
user_ECpwd_chk=checkvalue(1,trim(request.Form("chongpan_ce_pwd_chk")))
if user_pwd<>user_pwd_chk then
response.End
end if
if user_ECpwd<>user_ECpwd_chk then
response.End
end if
