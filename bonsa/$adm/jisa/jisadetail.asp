...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   <%
                  sql="select name from distributor1 where number="&bonsa_no
                 ...
                 %>
                  <%else 
                    ...
                    sql="select * from distributor15 where user_id='"&user_id&"'"
                 ...
                 %>
                  <%else 
	                    ...
	                    For i = 0 to UBound(Rows)-1
		                    ...
		                    user_id = Cols(1)		    
                            user_nm = Cols(3)	
                            sql="select distribute15_rate from distributor15 where user_id='"&user_id&"'"
            
                            user_rate = CDbl(Replace(GetString_List(sql),RowDel,""))
                            gold = Cols(15)
                            reg_date= Cols(9)		    		    
                   ...
                   %>
                    <form data-parsley-validate class="form-horizontal form-label-left" name="frm1" method="post" action="update_jisa_pwd_ok.asp">
                        <input type="hidden" name="user_id" value="<%=user_id%>" />
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">운영본사이름
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <label class="control-label" for="user_id"><%=boss_name%></label>
                      ...
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">본사이름
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
