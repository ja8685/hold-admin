...
<%
  ...
  sql="select deal_money,name,register_date,distribute3_rate from distributor3 where user_id = '"&user_id&"'"
 ...
 %>
  <%else 
   ...
   %>
                    <form data-parsley-validate class="form-horizontal form-label-left" name="frm1" method="post" action="update_shop_pwd_ok.asp">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">매장이름
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
