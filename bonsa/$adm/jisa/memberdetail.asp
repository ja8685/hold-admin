...
<!--
    function goWrite() {
        ...
        */
        ...
        if (f.chongpan_ce_pwd.value != f.chongpan_ce_pwd_chk.value) {
...
<%
 ...
 %>
  ...
  sql="select F_NAME,F_REGDATE,F_REGIP from AX_GAMEUSERLIST where F_GAMEID = '"&user_id&"'"
   ...
   %>
                    <form data-parsley-validate class="form-horizontal form-label-left" name="frm1" method="post" action="update_user_pwd_ok.asp">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="user_pwd" class="date-picker form-control col-md-7 col-xs-12" style="ime-mode:disabled;" name="user_pwd" type="password">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="user_pwd_chk" class="date-picker form-control col-md-7 col-xs-12" style="ime-mode:disabled;" name="user_pwd_chk" type="password">
                        </div>
                      </div>                             
                      <div class="ln_solid"></div>
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="chongpan_ce_pwd" class="date-picker form-control col-md-7 col-xs-12" style="ime-mode:disabled;" name="chongpan_ce_pwd" type="password">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="chongpan_ce_pwd_chk" class="date-picker form-control col-md-7 col-xs-12" style="ime-mode:disabled;" name="chongpan_ce_pwd_chk" type="password">
                        </div>
                      </div>                             
                      <div class="ln_solid"></div>   
                      <div class="form-group">
