...
sql="select deal_money from distributor15 where user_id IN ('" & request.Cookies(admincheck)("adminID") & "')"
...
sql=sql&" where b.jisa_id='"&adminID&"' and grade in  (15,2,3,4)"
...
'sql=sql&" where b.jisa_id='"&adminID&"'" 
                    ...
                    <%
                     ...
                     %>
                      ...
                      <%else 
                          ...
                          sql=sql&" select a.* from GiftToLog a with(nolock) inner join v_all_member_list b with(nolock) on a.from_user=b.user_id where b.jisa_id='"&adminID&"' and grade in  (15,2,3,4)"
                          sql=sql&" and date between '"&sdate&"' and '"&ldate&"'"&searchSQL
                          'sql=sql&" union "
                          'sql=sql&"   select a.* from GiftToLog a with(nolock) inner join v_all_member_list b with(nolock) on a.to_user=b.user_id where b.jisa_id='"&adminID&"' "
                          'sql=sql&" and date between '"&sdate&"' and '"&ldate&"'"&searchSQL
                      ...
                      <div class="form-inline form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-inline">
                            ...
                            <!--label class="form-control col-sm-2">닉네임 : </!--label><input type="text" name="request_nick" id="request_nick" class="form-control col-sm-2" /--> 
                                     <input type="button" class="btn btn-info form-control" onclick="chk_id()" value=" 보유 머니 조회  ">
                        </div>
                      </div>
