...
elseif IDAuth = 2 then
    ...
    sql = sql&" union all "
    sql = sql&" select chongpan_id,shop_id,sum(a.money) as income_amt_save,0 as incoume_amt,0 as outcome_amt,0 as outcome_save_amt,0 as rest_amt,0 as betting_amt,0 as deal_use_money"
    ...
    sql = sql&" union all "
    sql = sql&" select chongpan_id,shop_id,0 as income_amt_save,0 as incoume_amt,0 as outcome_amt,sum(a.money) as outcome_save_amt,0 as rest_amt,0 as betting_amt,0 as deal_use_money"
    sql = sql&" ,0 as bonsa_commission,0 as chongpan_commision,0 as shop_commission,'Y' as status,date "
                    ...
                    <table id="boss_deal_pay_list_table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr class="alert alert-info alert-dismissible fade in">
	                        <th align="center" height="25"><b>번호</b></th>        
                            <th align="center" height="25"><b>매장ID</b></th>            
                            <th align="center" height="25"><b>충전금액</b></th>
                            <th align="center" height="25"><b>충전(선물)</b></th>
                            <th align="center" height="25"><b>환전금액</b></th>
                            <th align="center" height="25"><b>환전(선물)</b></th>
                            <th align="center" height="25"><b>베팅액</b></th>                
                            <th align="center" height="25"><b>딜비</b></th>                
                            <th align="center" height="25"><b>유저보유머니</b></th>                        
                            <th align="center" height="25"><b>잭팟금액</b></th>                        
                            <th align="center" height="25"><b>매장수익</b></th>  
                        </tr>
                      </thead>
                      <tbody>
                       <%
                         ...
                         %>
                          ...
                          <%else 
	                            ...
	                            For i = 0 to UBound(Rows)-1
                                    ...
                                    set rs3 = nothing
                                    sql="select isnull(sum(deal_money),0) from distributor3 with(nolock) where user_id='"&Cols(1)&"'"            
                                    
                                    set rs3 = GameDBconn.execute(sql)
                                    if not rs3.eof then
                                        shop_money = cdbl(trim(rs3(0)))
                                    else
                                        shop_money= 0
                                    end if
                                    set rs3 = nothing
