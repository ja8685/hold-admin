              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <%
                      ...
                      sql="select deal_money,name,register_date from distributor3 where user_id = '"&user_id&"'"
                     ...
                     %>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">매장이름 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
