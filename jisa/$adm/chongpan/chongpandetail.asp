            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <%
                      sql="select name from distributor15 where number="&bonsa_no
                     ...
                     %>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <input type="password" name="user_pwd" size="20" class="form-control" maxlength="15" />
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">패스워드 확인 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <input type="password" name="user_pwd_chk" size="20" class="form-control" maxlength="15" />
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                      ...
                      <div class="form-group text-center">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button class="btn btn-info" onclick="goWrite()" type="reset">수정</button>
