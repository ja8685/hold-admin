...
bonsa_no    = Request("bonsa_no")
sql="select user_id from distributor15 where number="&request.Cookies(admincheck)("adminNo")
jisa_id  = Replace(GetString_List(sql),RowDel,"")            
end if
     
    sql="select distribute15_rate from distributor15 where number="&request.Cookies(admincheck)("adminNo")            
    bonsa_rate_tot = cdbl(Replace(GetString_List(sql),RowDel,""))                        
    shop_rate = bonsa_rate_tot   
    if shop_rate>3 then 
        shop_rate= 3'총판 수수료 MAX
        bonsa_rate_tot = 3
    end if
   closeGameDB   
...
<!--//
 ...
 function chk_id() {
        ...
        xmlHttp.open("get", "view_chongpan_game_id.asp?request_id=" + escape(id) +"&grade=4", false);
...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                 
                    <form class="form-horizontal form-label-left" name="frm1" method="post" action="insert_chongpan_ok.asp?bonsa_no=<%=bonsa_no%>&chongpan_no=<%=chongpan_no%>&bonsa_rate_tot=<%=bonsa_rate_tot%>&bonsa_rate=<%=bonsa_rate%>">
                        <input type="hidden" name="user_id" value="<%=user_id%>" />
                        <input type="hidden" name="exist_id" value="N" />                        
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">본사ID 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <label class="control-label" for="user_id"><%=jisa_id%></label>
                      ...
                      <div class="ln_solid"></div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">총판명
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class="control-label" for="user_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class="control-label" for="user_id">
                              <input type="text" name="chongpan_mail" maxlength="200" />
                          </label>
                        </div>
                      </div>
                      <div class="ln_solid"></div> 
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="bubonsa_pwd" class="date-picker form-control col-md-7 col-xs-12" name="chongpan_pwd" type="password">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="bubonsa_pwd_chk" class="date-picker form-control col-md-7 col-xs-12" name="chongpan_pwd_chk" type="password">
                        </div>
                      </div>                             
                      <div class="ln_solid"></div>      
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">딜비 수수료 비율
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="chongpan_rate" class="date-picker form-control col-md-7 col-xs-12" name="chongpan_rate" type="text">
