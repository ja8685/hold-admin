...
sql="select count(*) from common_game_log a inner join users b on a.user_id=b.user_id  where 1=1 and b.user_distributor15_link IN (" & request.Cookies(admincheck)("BubonJisaNo") & ")" & searchSQL
                ...
                <div class="x_panel">
                  ...
                  <%
                        If keyword <> "" Then
	                        ...
	                        SQL = SQL & "					WHERE 1=1 and b.user_distributor15_link IN (" & request.Cookies(admincheck)("BubonJisaNo") & ")" & searchSQL
	                        SQL = SQL & "			) AA "
                        ...
                        %>
                             <tr height="25"> 
	                            ...
	                            <td align="center" height="25" width="83">
                                    <input type=button name=headregist value=" 보기 " onClick="document.location.href = '/$adm/member/gamelog_detail.asp?game_id=<%=game_id%>&<%=parameters%>'" class="btn btn-info form-control" />
